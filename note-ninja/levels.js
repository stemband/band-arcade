/* Note Ninja belts (the levels). Tweak freely; the game reads everything from here.
   ...
   MAT: reorder, rename or recolor these to match your Band Ninja belts. Each line is one belt,
   in the order students earn them. To change a belt's color, pick a different `color` token below
   (or change that token's color in shared/theme.css: --belt-white, --belt-yellow, …).
     ...
     color    'belt-white' | 'belt-yellow' | 'belt-orange' | 'belt-green' | 'belt-blue' | 'belt-purple' | 'belt-brown' | 'belt-black'
...
window.NINJA_BELTS = [
  ...
  {name: 'Purple', color: 'belt-purple', count: 15, time: 5,   guides: 0,   onStaff: 3, pool: 5, blurb: 'Three notes at once, less time.'},
  {name: 'Brown',  color: 'belt-brown',  count: 16, time: 4.5, guides: 0,   onStaff: 4, pool: 5, blurb: 'Four notes at once.'},
  {name: 'Black',  color: 'belt-black',  count: 20, time: 3.5, guides: 0,   onStaff: 4, pool: 5, blurb: 'Twenty notes, fastest, four at once.'},
];
window.NINJA_RULES = {

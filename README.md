...
- **Select Player:** character select music (`select-music`, a loop; until you upload one, a built-in original chiptune plays), `tile-move`, `player-select`, `player-continue`, `player-ready`, `player2-join`, and the skin sounds. The music replaces the room ambience there and fades out as the game opens.
